...
export const THEMES = {
  ...
  prophetis:  { bg:'#0a0a0a', fg:'#fafafa', panel:'#141414', border:'#262626', red:'#dc2626',
                advanced: { sendBtnBg: '#dc2626', sendBtnHover: '#b91c1c',
                            userBubbleBg: '#1a1a1a', aiBubbleBg: '#141414',
                            inputBg: '#1a1a1a', inputBorder: '#262626',
                            sidebarBg: '#0a0a0a', brandColor: '#dc2626' } },
};
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Brand Color',    group: 'Sidebar' },
