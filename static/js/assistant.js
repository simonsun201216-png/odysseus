...
// Boot immediately when this module is dynamically imported.
// (No DOMContentLoaded guard — this runs as soon as the module loads,
// which happens on-demand from app.js rather than at page render time.)
_boot();
