...
FUNCTION_TOOL_SCHEMAS = [
    ...
    # ── OpenBB Financial Data Tools ──
    {
        ...
        "function": {
            "name": "openbb_quote",
            "description": "Get real-time or delayed stock quote data for one or more symbols. Returns price, change, volume, bid/ask, 50d/200d MA, YTD performance, and company name. Uses yfinance as default provider. Example: openbb_quote(symbol='AAPL')",
            "parameters": {
                "type": "object",
                "properties": {
                    "symbol": {"type": "string", "description": "Ticker symbol(s). Multiple symbols: comma-separated (e.g. 'AAPL,MSFT,GOOGL') or space-separated"},
                },
                "required": ["symbol"]
            }
        }
    },
    {
        "type": "function",
        "function": {
            "name": "openbb_historical",
            "description": "Get historical OHLCV price data for a symbol. Returns daily open, high, low, close, volume, and dividends/splits. Date format: YYYY-MM-DD. Max 2 years of daily data. Examples: openbb_historical(symbol='AAPL', start_date='2026-01-01', end_date='2026-06-30')",
            "parameters": {
                "type": "object",
                "properties": {
                    "symbol": {"type": "string", "description": "Ticker symbol"},
                    "start_date": {"type": "string", "description": "Start date YYYY-MM-DD (optional, default: 1 year ago)"},
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Get financial statement data for a company. Supports income statement (income), balance sheet (balance), and cash flow statement (cash). Returns annual data with 30+ fields. Example: openbb_fundamentals(symbol='AAPL', statement='income') returns revenue, net income, EPS, EBITDA, etc.",
            "parameters": {
                "type": "object",
                "properties": {
                    "symbol": {"type": "string", "description": "Ticker symbol"},
                    "statement": {"type": "string", "enum": ["income", "balance", "cash"], "description": "Statement type: income=income statement, balance=balance sheet, cash=cash flow"},
                },
    ...
    },
    {
        ...
        "function": {
            "name": "openbb_macro",
            "description": "Get macroeconomic indicator data from FRED. Supports GDP, CPI, UNRATE (unemployment), FEDFUNDS (Fed rate), DGS10 (10Y Treasury), DGS2 (2Y Treasury), T5YIE (5Y breakeven), T10YIE (10Y breakeven), M2SL (money supply), etc. Example: openbb_macro(symbol='GDP', start_date='2024-01-01')",
            "parameters": {
                "type": "object",
                "properties": {
                    "symbol": {"type": "string", "description": "FRED series ID (e.g. GDP, CPI, UNRATE, FEDFUNDS, DGS10, DGS2, T5YIE, T10YIE, M2SL, BAA10Y)"},
    ...
    },
    {
        ...
        "function": {
            "name": "openbb_search",
            "description": "Search for financial instruments, companies, or equities by name or keyword. Returns matching symbols and descriptions. Example: openbb_search(query='Apple') returns AAPL with company details, sector, industry. Also supports searching by sector or industry.",
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {"type": "string", "description": "Search query - company name, symbol, sector, or industry keyword"},
                },
                "required": ["query"]
            }
        }
