...
_ADMIN_KEYWORDS = [
    ...
    "bash", "shell", "python", "read_file", "write_file", "edit_file",
    "grep", "glob", "ls", "filesystem", "file system", "file", "files",
...
async def stream_agent_loop(
    ...
    public_blocked_tools = set() if bypass_public_tool_block else blocked_tools_for_owner(owner)
            ...
            async def _run_tool():
                try:
                    return await execute_tool_block(
                        ...
                        workspace=workspace,
                        bypass_public_tool_block=bypass_public_tool_block,
                    )
                finally:
